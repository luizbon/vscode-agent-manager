...
suite("AgentMarketplaceProvider Test Suite", () => {
  ...
  test("resolveWebviewView sets up webview", () => {
    ...
    assert.ok(
      (mockWebviewView.webview.html as string).includes("Agent Marketplace"),
    );
    assert.ok(
      (mockWebviewView.webview.onDidReceiveMessage as sinon.SinonStub).called,
    );
  });
  ...
  test("updateAgents posts message to webview", () => {
    ...
    const postMessageStub = mockWebviewView.webview
  ...
  test("Message handling: installAgent", () => {
    ...
    // Simulate message
    const onDidReceiveMessageStub = mockWebviewView.webview
      .onDidReceiveMessage as sinon.SinonStub;
